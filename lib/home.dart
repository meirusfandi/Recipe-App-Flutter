...
class _HomePageState extends State<HomePage> {
  ...
  onSearchTextChanged(String text) async {
    ...
    data.forEach((val) {
      if (val.strMeals.toLowerCase().contains(text.toLowerCase()))
          ...
          Expanded(
            child: _search.text.isNotEmpty
              ...
              : data.length != 0
                ...
                : Center(child: Text('No data found', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20),)),
          )
        ],
      )
    );
